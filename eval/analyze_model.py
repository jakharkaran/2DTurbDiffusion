...
if long_analysis_config['data_type'] == 'emulator':
    ...
    if diffusion_config['conditional']:
        # Conditional: go to subfolder with name diffusion_config['enemble_num'] under 'data'
        
        ensemble_dir = os.path.join(root_dir, 'data', str(long_analysis_config['enemble_num']))
...
if long_analysis_config['data_type'] == 'emulator' and diffusion_config['conditional']:
    save_dir = os.path.join(save_dir, 'analysis', long_analysis_config['data_type'], str(long_analysis_config['enemble_num']))
else:
